"""
Kalibrasyonsuz Görme Modeli ve Logit Çıkarıcı
--------------------------------------------
Tipik bir modern derin modelin sergilediği aşırı güven (overconfidence)
davranışını simüle eden ve logitleri toplayan Vision modeli.
...
class GuvenilmezVisionModeli(nn.Module):
    """
    ...
    @classmethod
    def logit_topla(cls, model: nn.Module, veri_loader: DataLoader, cihaz: str = "cpu") -> Tuple[torch.Tensor, torch.Tensor]:
        """
        Veri kümesi üzerindeki tüm ham logitleri ve etiketleri toplar.
        """
