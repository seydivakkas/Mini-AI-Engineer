...
- **Tamamlanan:** Gün 01 - Gün 77 (%100 eksiksiz tamamlandı ve test edildi - FAZ 1, FAZ 2 ve FAZ 3 TAMAMLANDI; FAZ 4 devam ediyor).
- **Sıradaki Gün:** Gün 78 (`day-78-transformer-encoder-from-scratch` — Sıfırdan Transformer Encoder Bloğu: Pozisyonel Kodlama, LayerNorm, Residual FFN).
