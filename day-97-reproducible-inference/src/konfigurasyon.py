"""
MiniViT Konfigürasyon Modülü (Day 97 - Reproducible Inference).
Hugging Face PretrainedConfig tabanlı serileştirilebilir konfigürasyon sınıfı.
"""
...
class MiniViTConfig(PretrainedConfig):
    """
    Mini Vision Transformer için PretrainedConfig sınıfı.
